...
/**
 * NfRegistryAboutDialog constructor.
 *
 ...
 * @constructor
 */
function NfRegistryAboutDialog(nfRegistryApi, nfRegistryService, matDialogRef, router) {
...
NfRegistryAboutDialog.prototype = {
    constructor: NfRegistryAboutDialog,
...
NfRegistryAboutDialog.annotations = [
    new Component({
        templateUrl: './nf-registry-about-dialog.html'
    })
];

NfRegistryAboutDialog.parameters = [
    NfRegistryApi,
    NfRegistryService,
    MatDialogRef,
...
export default NfRegistryAboutDialog;
